  ...
  return (
    <div className="min-h-screen bg-brand-cream">
      <div className="bg-brand-primary text-white py-16 px-4 text-center">
        ...
        <h1 className="font-display text-4xl md:text-5xl font-light">Best Sellers</h1>
        <p className="mt-3 text-white/70 text-sm">The pieces our customers love most</p>
      </div>
      <div className="max-w-7xl mx-auto px-4 py-12">
        {bestSellers.length === 0 ? (
          <EmptyState title="No best sellers yet" message="As our customers fall in love, their favourites will appear here." />
        ) : (
          <>
