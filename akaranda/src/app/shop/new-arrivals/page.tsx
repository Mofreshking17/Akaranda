  ...
  return (
    <div className="min-h-screen bg-brand-cream">
      <div className="bg-brand-brown text-white py-16 px-4 text-center">
        ...
        <h1 className="font-display text-4xl md:text-5xl font-light">New Arrivals</h1>
        <p className="mt-3 text-white/70 text-sm">Fresh Afro-inspired designs added weekly</p>
      </div>
      <div className="max-w-7xl mx-auto px-4 py-12">
        {newArrivals.length === 0 ? (
          <EmptyState title="No new arrivals just yet" message="Fresh designs drop weekly — check back very soon." />
        ) : (
          <>
