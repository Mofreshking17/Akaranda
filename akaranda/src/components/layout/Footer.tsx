...
import { getSettings, getContactInfo } from "@/lib/data";
...
export default async function Footer() {
  ...
  const waNumber = (whatsapp.number || "").replace(/\D/g, "") || "2348000000000";
  const email = contact.email || "hello@akaranda.com";
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li className="flex items-center gap-3 text-brand-sand/70 text-sm">
              ...
              <a href={`https://wa.me/${waNumber}`} className="hover:text-brand-secondary transition-colors">WhatsApp Us</a>
            </li>
            <li className="flex items-center gap-3 text-brand-sand/70 text-sm">
