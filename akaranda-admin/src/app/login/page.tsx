    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/40 px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-semibold tracking-tight text-foreground">AKARANDA</h1>
        ...
        <form action={signIn} className="bg-card border border-border rounded-lg p-6 space-y-4 shadow-sm">
          ...
          <button
            type="submit"
            className="w-full bg-primary text-white rounded-md py-2.5 text-sm font-medium hover:bg-primary/90 transition-colors"
          >
            Sign In
          </button>
        </form>
